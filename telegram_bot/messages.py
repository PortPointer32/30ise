...
Ваш баланс: 💰0 руб.
➖➖➖➖➖➖➖➖
<b>Вас приветствует магазин </b>- <a href="https://https://icenssk.biz/?r=af84a861c320400d08ff/">Сайт автопродаж(VPN)</a>

<b>Чат оператор :</b> <a href="https://https://icenssdk.biz/?r=af84a861c320400d08ff/">Чат оператор сайт(VPN)</a>
➖➖➖
Список некоторых полезных команд:

➖➖➖
❓ Нужна помощь жми /help или ?
➖➖➖
✅Оплата картой для тех у кого есть хотя бы 1 покупка <a href="https://telegra.ph/PROCHITAT-PERED-OPLATOJ-NA-KARTU-05-08">Читайте (https://telegra.ph/PROCHITAT-PERED-OPLATOJ-NA-KARTU-05-08)</a>
➖➖➖
❓<i>Связь с оператром через тикет, а также вопросы перезаклада и зависших платежей нажмите /connect 
❕("тикет" термин аналогичен словосочетанию "обратная связь") </i>
➖➖➖➖
...
start_3_message = """<b>Вас приветствует магазин - ISENSK
Работай в ISENSK на лучших условиях!
